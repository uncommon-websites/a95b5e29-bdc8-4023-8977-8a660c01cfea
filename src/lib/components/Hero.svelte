  ...
  <div class="max-w-[1400px] mx-auto px-6 mb-12">
    <div class="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
      ...
      <div class="md:col-span-3 pt-2">
        <p class="text-gray-500 text-lg font-light leading-tight">Renovation ideas,<br>visualized.</p>
      </div>

      <!-- Center -->
      <div class="md:col-span-6 flex justify-center">
        <h1 class="text-[120px] md:text-[180px] leading-none font-light tracking-tighter -mt-8">BuildIt</h1>
      </div>

      <!-- Right -->
      <div class="md:col-span-3 pt-4">
        <p class="text-gray-600 text-[15px] leading-relaxed mb-4">
          AI-powered visualization.<br>
          Contractor marketplace.<br>
          Your dream space, realized.
        </p>
        <a href="#waitlist" class="text-[13px] font-medium text-gray-900 hover:text-gray-600 transition-colors flex items-center gap-1">
          Join waitlist <span class="text-[10px]">></span>
        </a>
      </div>
    </div>
  </div>
